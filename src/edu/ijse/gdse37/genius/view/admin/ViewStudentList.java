 ...
 * @author Dinuka
 */
public class ViewStudentList extends javax.swing.JPanel {

    private static ManageStudentPanel manageStudentPanel;
     ...
     */
    public ViewStudentList(Admin_Main_Window admin_Main_Window) {
        initComponents();
    ...
    private void initComponents() {
        ...
        detailTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Id", "Name", "Email", "Tel", "NIC", "Password"
            }
        ) {
        ...
        try {
            ...
            if (studentList != null) {
                for (Student student : studentList) {
                    Object[] data = {student.getStudent_id(), student.getName(), student.getEmail(),
                        student.getTel(), student.getNic(), Encription.decriptTxt(student.getPassword())};
                    dtm.addRow(data);
                }
            } else {
    ...
    private void cancelBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelBtnActionPerformed
        ...
        manageStudentPanel = new ManageStudentPanel(admin_Main_Window);
        Admin_Main_Window.mainWindowPanel.removeAll();
        Admin_Main_Window.mainWindowPanel.add(manageStudentPanel);
